...
.EXAMPLE
	 .\show-IBNetwork.ps1 -search -network "10.96.240"

	search for network containers or networks information that contains '10.96.240'.
.EXAMPLE
	.\show-IBNetwork.ps1 -print -network "10.10.240.0/21"
	10.10.240.0/21
			10.10.241.0/28
			10.10.242.0/24
					10.10.242.0/27
	...
	Print out the subnet tree for the network 10.96.240.0/21.
.EXAMPLE
	 .\show-IBNetwork.ps1 -search -network "10.96.240" -refresh -ipamhost ipam.xxxx.com -credential (Get-Credential)

	Refresh the network/network containers information and print out the tree for the network '10.96.240' and supply explicit credential.
.EXAMPLE
	 .\show-IBNetwork.ps1 -print -network "10.96.240.0/21" -refresh -ipamhost ipam.xxxx.com -credential (Get-Credential)

	Refresh the network/network containers information and print out the tree for the network '10.96.240.0/21'.
.LINK
...
################################################################################
## Example data in the two variables ibnetworks and ibnetworkcontainers.
################################################################################
#
#PS:[83] # $ibnetworks | select-object -first 1 *
#
#
#_ref              : network/ZG5zLm5ldHdvcmskMTAuMTEuMjQuMC8yNy8w:10.11.24.0/27/xxxxxxxxxxx
#comment           : 9th floor
#network           : 10.11.24.0/27
#network_container : 10.11.24.0/24
#network_view      : xxxxxxxxxx 
#
#
#[20190410 14:13] [ C:\Scripts\Powershell ] [git:master]
#PS:[84] # $ibnetworkcontainers | select-object -first 1 *
#
#
#_ref              : networkcontainer/ZG5zLm5ldHdvcmtfY29udGFpbmVyJDEwLjYuMC4wLzE2LzA:10.6.0.0/16 xxxxxxxxxx/
#comment           : Block Assignment - Vlans 10000-19999
#network           : 10.6.0.0/16
